...
set inp=%1
start /b vlc https://video-ws2.lv-play.com/live/%inp%S.flv --sout "#file{dst=E:\Videos\%inp%_ss_w_%dirname%_%timename%.mp4,no-overwrite}"  --tcp-caching=6000 --ipv4-timeout=90  --sout-keep vlc://quit
echo %inp%
