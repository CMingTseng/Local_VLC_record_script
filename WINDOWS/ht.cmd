...
set inp=%1
start /b vlc https://video-wshls.langlive.com/live/%inp%Y.flv --sout "#file{dst=E:\Videos\%inp%_h_w_%dirname%_%timename%.mp4,no-overwrite}"  --tcp-caching=6000 --ipv4-timeout=90  --sout-keep vlc://quit
echo %inp%
